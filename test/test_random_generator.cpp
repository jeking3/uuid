...
void test_examples()
{
    ...
    // less secure manner, use random_generator_bulk instead.
    // there is a test (test_bench_random) that determines the
    // cut-off point where it is more wall-time efficient to 
    // use bulk over standard.
    boost::uuids::random_generator_bulk bulkgen;
