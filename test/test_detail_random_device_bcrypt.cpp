...
#define BCRYPT_ENABLED
#endif

#if (defined(BCRYPT_ENABLED) || defined(BOOST_UUID_RANDOM_DEVICE_FORCE_BCRYPT)) && defined(BOOST_UUID_TESTSTUBS) && defined(_MSC_VER)
...
int main(int, char*[])
{
#if (defined(BCRYPT_ENABLED) || defined(BOOST_UUID_RANDOM_DEVICE_FORCE_BCRYPT)) && defined(BOOST_UUID_TESTSTUBS)
