 ...
 * define BOOST_UUID_RANDOM_DEVICE_FORCE_BCRYPT
 *
...
//
  ...
  typedef basic_random_device<random_device_cloudabi<unsigned int> > random_device;
#elif defined(BOOST_WINDOWS)
# if (BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM) && !defined(BOOST_UUID_RANDOM_DEVICE_FORCE_BCRYPT)
   typedef basic_random_device<random_device_wincrypt<unsigned int> > random_device;
# else
   typedef basic_random_device<random_device_bcrypt<unsigned int> > random_device;
# endif
#else
  typedef basic_random_device<random_device_file<unsigned int> > random_device;
#endif
